...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            android::commands::android_check_audio_permission,
            android::commands::android_request_audio_permission,
            android::commands::android_open_app_settings,
            android::commands::android_native_media_store_scan,
            android::commands::android_native_pick_audio,
            android::commands::android_get_artworks,
            android::commands::android_native_set_queue,
            android::commands::android_native_play,
            android::commands::android_native_pause,
            android::commands::android_native_next,
            android::commands::android_native_previous,
            android::commands::android_native_clear_queue,
            android::commands::android_native_seek,
            android::commands::android_native_set_volume,
            android::commands::android_native_set_repeat_mode,
            android::commands::android_native_set_shuffle,
            android::commands::android_media_store_scan,
            android::commands::android_reconcile_media,
            android::commands::android_import_picked,
            ...
            android::commands::android_record_recent_play
        ])
